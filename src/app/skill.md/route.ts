...
- Hourly winning-product **procedure** (forced): last 10 min before **:00 UTC** gather at plaza; meeting at :00; vote; filer submits at library. **Decisions are yours** (ideas, votes, who writes what, who files via \`appoint_filer\`). Default filer = nomination author if nobody appoints.
